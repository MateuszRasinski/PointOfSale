...
public class MoneyTest {
    ...
    public void shouldNotAddDifferentCurrency() {
        //given
        Money money1 = new Money("3.415", Locale.GERMANY);
        Money money2 = new Money("0.13", Locale.US);
        //when
        money1.add(money2);
    }

    @Test
    public void shouldToStringDefaultLocale() {
        //given
        Money money = new Money("7.67542");
        //when
        String toString = money.toString();
        //then
        assertThat(toString).isEqualTo("7,68 zł");
    }

    @Test
    public void shouldToStringLocaleUS() {
        //given
        Money money = new Money("7.67542", Locale.US);
        //when
        String toString = money.toString();
        //then
        assertThat(toString).isEqualTo("$7.68");
    }
}